...
{#if popup !== undefined}
  ...
  >
    <input
      ...
      readonly
      value={peer.id}
      class="w-[80%] text-center text-[2vw] font-mono"
    />
    <svg
      ...
      /><g id="SVGRepo_iconCarrier">
        ...
        <path
          ...
          stroke-width="1.5"
        />
        <path d="M8 14H9M16 14H12" stroke-width="1.5" stroke-linecap="round" />
        <path
    ...
    >
    <p class="pt-[2%]">Please share this code with your friend 😊</p>
  </div>
{/if}
